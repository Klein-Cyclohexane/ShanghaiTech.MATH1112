# ShanghaiTech.MATH1112
ShanghaiTech MATH1112 Linear Algebra Fall 2025
...
## REFERENCE BOOK
《Elementary Linear Algebra》11th Edition  Howard Anton, Chris Rorres  
《高等代数》丘维声  
《高等代数学习指导书》 丘维声

## TIPS：
1.The textbook was compiled from the lecture notes of the Linear Algebra （Honor）course offered by Academician Xi at ShanghaiTech University Institute of Mathematical Sciences in 2024. ~*（Due to its unconventional logical structure and language expression, it has been widely criticized by students of the 2025 academic year.）*~

2.《Elementary Linear Algebra》was used as the textbook before 2025.

3.《高等代数》和《高等代数学习指导书》俗称“丘砖”，是线性代数领域神一般的存在，基本上把丘砖题目看完，~考试的时候大概率能碰到原题。~
